		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand"
					href="${pageContext.request.contextPath}/login"><img alt="logo"
					src="${pageContext.request.contextPath}/resources/images/irs_logo3.jpg"
					height="42px;"></a>
			</div>
			<!-- /.navbar-header -->
					...
					<ul class="nav" id="side-menu">
						...
						<li><a href="#"><i class="fa fa-edit fa-fw"></i>
							...
							<ul class="nav nav-second-level">
								<li><a
									href="${pageContext.request.contextPath}/newrequirement">New
										Requirement</a></li>
								<li><a href="#"> Search Requirements</a></li>
							</ul></li>
						<li style="display: none"><a href="#"><i
								class="fa fa-bar-chart-o fa-fw"></i> Design<span
								class="fa arrow"></span></a> <!-- /.nav-second-level --></li>
						<li><a href="#"><i class="fa fa-table fa-fw"></i> Defects</a>
						</li>
						<li><a href="#"><i class="fa fa-wrench fa-fw"></i>
								Reviews</a></li>
						<li><a href="#"><i class="fa fa-wrench fa-fw"></i>
								Settings<span class="fa arrow"></span></a> <!-- /.nav-second-level -->
						</li>
					</ul>
				</div>
				<!-- /.sidebar-collapse -->
							...
							<div class="row">
									...
									<div class="row">
										<div class="col-lg-3">
											<div class="form-group">
												<label for="disabledSelect">Release #</label> <input
													class="form-control" id="disabledInput" type="text"
													placeholder="Disabled input" value="45" disabled>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label for="disabledSelect">Requirement #</label> <input
													class="form-control" id="disabledInput" type="text"
													placeholder="Disabled input" value="547" disabled>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label for="disabledSelect">Date</label> <input
													class="form-control" id="disabledInput" type="text"
													placeholder="Disabled input" value="5/23/2016" disabled>
											</div>
										</div>
										<div class="col-lg-3">
											<div class="form-group">
												<label for="disabledSelect">Author</label> <input
													class="form-control" id="disabledInput" type="text"
													placeholder="Disabled input" value="John, Rambo" disabled>
											</div>
										</div>
									</div>
								</div>
										...
										<div class="col-lg-3">
											<div class="col-lg-12">
												<div class="panel panel-default">
													...
													<div class="panel-body">
														<div class="col-lg-12">
															<a href="#" class="fa fa-video-camera"> Upload /
																capture videos</a>
														</div>
													</div>
													<div class="panel-body">
														<div class="col-lg-12">
															<iframe width="150" height="130"
																...
																https://www.youtube.com/watch?v=0iA8uPieRF0 </iframe>
														</div>
													</div>
												</div>
											</div>
								...
								<div class="col-lg-12">
									<div class="chat-panel panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-comments fa-fw"></i> Queries
											...
											<ul class="chat">
												<li class="left clearfix"><span
													...
													<div class="chat-body clearfix">
														<div class="header">
															<strong class="primary-font">iRs assistant</strong> <small
