         ...
         <body>
            <div id="wrapper">
                  ...
                  <div class="navbar-default sidebar" role="navigation">
                     <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                           ...
                           <li>
                              <a href="${pageContext.request.contextPath}/login"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                           </li>
                           <li>
               ...
               <div id="page-wrapper">
                  <div class="row">
                     <div class="col-lg-12">
                        <h2 class="page-header">Please fill the requirement details</h2>
                     </div>
                     <!-- /.col-lg-12 -->
                  </div>
                  <!-- /.row -->
                     ...
                     <div class="col-lg-12">
                        <div class="panel panel-default">
                           <div class="panel-heading">
                              Title : 
                              <input class="form-control" placeholder="Requirement title" >
                                    ...
                                    <div class="row">
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             <label for="disabledSelect">Release #</label>
                                             <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input" value="45" disabled>
                                          </div>
                                       </div>
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             <label for="disabledSelect">Requirement #</label>
                                             <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input" value="547" disabled>
                                          </div>
                                       </div>
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             <label for="disabledSelect">Date</label>
                                             <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input" value="5/23/2016" disabled>
                                          </div>
                                       </div>
                                       <div class="col-lg-3">
                                          <div class="form-group">
                                             <label for="disabledSelect">Author</label>
                                             <input class="form-control" id="disabledInput" type="text" placeholder="Disabled input" value="John, Rambo" disabled>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                       ...
                                       <div class="col-lg-3">
                                          <div class="col-lg-12">
                                             <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                   <div class="col-lg-12">
                                                      <a href="#" class="fa fa-video-camera" > Upload / capture videos</a>
                                                   </div>
                                                </div>
                                                <div class="panel-body">
                                                   <div class="col-lg-12">
                                                      <iframe width="150" height="130"
                                                         src="http://www.youtube.com/embed/lP8vjBrswSs?autoplay=0">
